<?php
    ...
    $query2="SELECT * FROM risposte_richieste_e_faq_view WHERE richiesta IN (SELECT DISTINCT id_richiesta FROM richieste_e_faq_view WHERE utente_creazione='".$_SESSION['Username']."') OPTION ( QUERYTRACEON 9481 )";	
