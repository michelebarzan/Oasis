<?php
	...
	$query="SELECT DISTINCT stazione FROM carico_verniciatura";
	...
	function getResiduo($conn,$stazione,$time)
	{
		...
		$query="SELECT SUM(ordini) AS ordini,SUM(pezzi) AS pezzi,SUM(mq) AS mq FROM carico_verniciatura WHERE settimana<$settimana AND stazione='$stazione'";
	...
	function getOrdini($conn,$stazione,$time)
	{
		...
		$query="SELECT ordini FROM carico_verniciatura WHERE stazione='$stazione' AND settimana=$settimana";
	...
	function getPezzi($conn,$stazione,$time)
	{
		...
		$query="SELECT pezzi FROM carico_verniciatura WHERE stazione='$stazione' AND settimana=$settimana";
	...
	function getMq($conn,$stazione,$time)
	{
		...
		$query="SELECT mq FROM carico_verniciatura WHERE stazione='$stazione' AND settimana=$settimana";
