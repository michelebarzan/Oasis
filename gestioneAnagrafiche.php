	...
	<body>
        ...
        <div class="funcionListContainer" style="top:100;">
			<div class="functionList">
				<button class="functionListButton" onclick="resetStyle(this);getTable('anagrafica_collezioni')">Anagrafica collezioni</button>
				<button class="functionListButton" onclick="resetStyle(this);getTable('anagrafica_linee_business')">Anagrafica linee business</button>
                <button class="functionListButton" onclick="resetStyle(this);getTable('anagrafica_livelli')">Anagrafica livelli</button>
                <button class="functionListButton" onclick="resetStyle(this);getTable('anagrafica_modelli')">Anagrafica modelli</button>
            </div>
		</div>
