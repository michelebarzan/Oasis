<?php
    ...
    $query2="SELECT * FROM richieste_e_faq_view WHERE utente_creazione='".$_SESSION['Username']."' AND stato IN ('$filtroStato_in') $filtroMacrocategoria $filtroCategoria OPTION ( QUERYTRACEON 9481 )";	
