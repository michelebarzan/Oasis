<?php
	...
	$query="SELECT DISTINCT stazione FROM storico_punto_punto";
	...
	function getResiduo($conn,$stazione,$time)
	{
		...
		$query="SELECT SUM(ordini) AS ordini,SUM(pezzi) AS pezzi FROM storico_punto_punto WHERE settimana<$settimana AND stazione='$stazione'";
	...
	function getOrdini($conn,$stazione,$time)
	{
		...
		$query="SELECT ordini FROM storico_punto_punto WHERE stazione='$stazione' AND settimana=$settimana";
	...
	function getPezzi($conn,$stazione,$time)
	{
		...
		$query="SELECT pezzi FROM storico_punto_punto WHERE stazione='$stazione' AND settimana=$settimana";
