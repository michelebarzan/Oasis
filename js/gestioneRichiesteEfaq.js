            ...
            function(response, status)
            {
                if(status=="success")
                {
                    ...
                    else
                    {
                        ...
                        id_richieste = id_richieste.concat(id_richieste_urgenti);
...
function appendNuovaReplica(username_risposta,data_risposta,id_richiesta,descrizione,allegati_risposte)
{
    ...
    if(document.getElementById("richiesteListItemBoxRisposteContainer"+id_richiesta).childNodes[0].innerHTML.indexOf("Ancora nessuna risposta")>-1)
