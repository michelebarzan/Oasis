<?php
    ...
    $output2 = exec('del "C:\\xampp\\htdocs\\Oasis\\files\\cloudFoto\\'.$cartella.'_'.$id_utente.'.rar" 2>&1');
    $output = exec('C:\\xampp\\htdocs\\Oasis\\files\\rar a "C:\\xampp\\htdocs\\Oasis\\files\\cloudFoto\\'.$cartella.'_'.$id_utente.'"'.$paths.' 2>&1');
