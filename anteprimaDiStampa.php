	...
	<body>
		<div id="centra" class="centra">
			<span id="stampaPalletB" class="stampaPalletB" >
				<br>
				<input type="submit" onClick="window.location = 'stampaPallet.php';" value="Annulla">
				<input type="submit" id="btnStampaOrizzontale" onClick="stampaOrizzontale()" value="Stampa orizzontale">
